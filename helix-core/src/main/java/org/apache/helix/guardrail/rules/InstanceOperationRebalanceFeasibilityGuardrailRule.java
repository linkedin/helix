 ...
 * <p>
 * <b>Check.</b> When the operation moves the target out of the pool, the rule delegates to the shared
 * {@link WagedRebalanceFeasibilityWhatIf}: it runs the read-only WAGED what-if (via the injected
